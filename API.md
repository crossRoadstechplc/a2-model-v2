...
Promote a user to admin by email. Caller must be admin.
...
**Response 200** – Promoted or already admin.

**Response 404** – User not found.

**Response 400** – Validation error (e.g. missing/invalid email).
...
**Example admin route:** `GET /admin/check` – requires auth + admin, returns `{ success: true, message: 'Admin access granted.' }`
